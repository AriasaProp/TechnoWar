...
void Main::render () {
  ...
  mdata->fnt->draw_text (0 + 10, engine::graph->getHeight (), ALIGN_TOP_LEFT, "Rev. 0000");
  mdata->fnt->draw_text (engine::graph->getWidth () * 0.5f, engine::graph->getHeight (), ALIGN_TOP, "Kam, 19 Mei 2023!");
