...
Main::Main () {
  ...
  //add texture regions
  {
    ...
    uistage::addTextureRegion("btn1" ,tex, uistage::texture_region{{0,0}, {x,y}, {10,10,10,10}});
    stbi_image_free (t);
    t = stbi_load_from_assets ("btn1_.png", &x, &y, nullptr, STBI_rgb_alpha);
    tex = engine::graph->gen_texture (x, y, t);
    uistage::addTextureRegion("btn1_",tex, uistage::texture_region{{0,0}, {x,y}, {10,10,10,10}});
    stbi_image_free (t);
  }
