...
struct flat_vertex rectangle[] = {
    {(struct vec2){800f, 100f}, (struct vec2){0.0f, 0.0f}},
    {(struct vec2){800f, 400f}, (struct vec2){0.0f, 0.0f}},
    {(struct vec2){100f, 100f}, (struct vec2){0.0f, 0.0f}},
    {(struct vec2){100f, 400f}, (struct vec2){0.0f, 0.0f}}};
