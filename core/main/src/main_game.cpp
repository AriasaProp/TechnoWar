...
void start () {
  ...
  uistage::loadUISkin ("uiskin/main/main");
  engine::mesh_core::data vert[24] = {
      //{{x,y,z}, 0xabgr
      // front red
      {{+250.0f, +250.0f, -250.0f}, {.color = 0xff0000ff}},
      {{+250.0f, -250.0f, -250.0f}, {.color = 0xff0000ff}},
      {{-250.0f, -250.0f, -250.0f}, {.color = 0xff0000ff}},
      {{-250.0f, +250.0f, -250.0f}, {.color = 0xff0000ff}},
      // left green
      {{-250.0f, +250.0f, -250.0f}, {.color = 0xff00ff00}},
      {{-250.0f, -250.0f, -250.0f}, {.color = 0xff00ff00}},
      {{-250.0f, -250.0f, +250.0f}, {.color = 0xff00ff00}},
      {{-250.0f, +250.0f, +250.0f}, {.color = 0xff00ff00}},
      // right blue
      {{+250.0f, +250.0f, +250.0f}, {.color = 0xffff0000}},
      {{+250.0f, -250.0f, +250.0f}, {.color = 0xffff0000}},
      {{+250.0f, -250.0f, -250.0f}, {.color = 0xffff0000}},
      {{+250.0f, +250.0f, -250.0f}, {.color = 0xffff0000}},
      // bot gray
      {{+250.0f, -250.0f, -250.0f}, {.color = 0xff333333}},
      {{+250.0f, -250.0f, +250.0f}, {.color = 0xff333333}},
      {{-250.0f, -250.0f, +250.0f}, {.color = 0xff333333}},
      {{-250.0f, -250.0f, -250.0f}, {.color = 0xff333333}},
      // top purple
      {{+250.0f, +250.0f, +250.0f}, {.color = 0xff00ffff}},
      {{+250.0f, +250.0f, -250.0f}, {.color = 0xff00ffff}},
      {{-250.0f, +250.0f, -250.0f}, {.color = 0xff00ffff}},
      {{-250.0f, +250.0f, +250.0f}, {.color = 0xff00ffff}},
      // back fulle
      {{-250.0f, +250.0f, +250.0f}, {.color = 0xffffff00}},
      {{-250.0f, -250.0f, +250.0f}, {.color = 0xffffffff}},
      {{+250.0f, -250.0f, +250.0f}, {.color = 0xffff0000}},
      {{+250.0f, +250.0f, +250.0f}, {.color = 0xff00ff00}}};
  ...
  uistage::makeButton ({"button_glassy_up", "button_glassy_down"}, Rect (100, 200, 200, 200, ALIGN_BOTTOM_LEFT, ALIGN_CENTER), [] () -> void {
    uistage::temporaryTooltip ("Tooltip test 1 for button 1. Hello!");
  });
  uistage::makeButton ({"button_glassy_up", "button_glassy_down"}, Rect (350, 200, 200, 200, ALIGN_BOTTOM_LEFT, ALIGN_CENTER), [] () -> void {
    uistage::temporaryTooltip ("Tooltip test 2 for button 2. Nothing happen?!");
  });
  uistage::makeImage ("unknow", Rect (600, 200, 200, 200, ALIGN_BOTTOM_LEFT, ALIGN_CENTER));
  uistage::makeButton ({"button_glassy_up", "button_glassy_down"}, Rect (850, 200, 200, 200, ALIGN_BOTTOM_LEFT, ALIGN_CENTER), [] () -> void {
    uistage::temporaryTooltip ("Tooltip test 3 for button 3. Yeah ;-)");
  });
  uistage::makeButton ({"button_glassy_up", "button_glassy_down"}, Rect (1100, 200, 200, 200, ALIGN_BOTTOM_LEFT, ALIGN_CENTER), [] () -> void {
    uistage::temporaryTooltip ();
  });
