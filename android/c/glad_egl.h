...
GLAPI int gladLoadEGL(GLADloadproc);
...
// EGL Core Functions
GLAPI EGLBoolean (*eglChooseConfig)(EGLDisplay, const EGLint *attrib_list, EGLConfig *configs, EGLint config_size, EGLint *num_config);
GLAPI EGLBoolean (*eglCopyBuffers)(EGLDisplay,EGLSurface, EGLNativePixmapType target);
GLAPI EGLContext (*eglCreateContext)(EGLDisplay, EGLConfig config, EGLContext share_context, const EGLint *attrib_list);
GLAPI EGLSurface (*eglCreatePbufferSurface)(EGLDisplay, EGLConfig config, const EGLint *attrib_list);
GLAPI EGLSurface (*eglCreatePixmapSurface)(EGLDisplay, EGLConfig config, EGLNativePixmapType pixmap, const EGLint *attrib_list);
GLAPI EGLSurface (*eglCreateWindowSurface)(EGLDisplay, EGLConfig config, EGLNativeWindowType win, const EGLint *attrib_list);
GLAPI EGLBoolean (*eglDestroyContext)(EGLDisplay, EGLContext);
GLAPI EGLBoolean (*eglDestroySurface)(EGLDisplay,EGLSurface);
GLAPI EGLBoolean (*eglGetConfigAttrib)(EGLDisplay, EGLConfig config, EGLint attribute, EGLint *value);
GLAPI EGLBoolean (*eglGetConfigs)(EGLDisplay, EGLConfig *configs, EGLint config_size, EGLint *num_config);
GLAPI EGLDisplay (*eglGetCurrentDisplay)(void);
GLAPI EGLSurface (*eglGetCurrentSurface)(EGLint readdraw);
GLAPI EGLDisplay (*eglGetDisplay)(EGLNativeDisplayType display_id);
GLAPI EGLint (*eglGetError)(void);
GLAPI EGLBoolean (*eglInitialize)(EGLDisplay, EGLint *major, EGLint *minor);
GLAPI EGLBoolean (*eglMakeCurrent)(EGLDisplay, EGLSurface draw, EGLSurface read, EGLContext);
GLAPI EGLBoolean (*eglQueryContext)(EGLDisplay, EGLContext, EGLint attribute, EGLint *value);
GLAPI const char *(*eglQueryString)(EGLDisplay, EGLint name);
GLAPI EGLBoolean (*eglQuerySurface)(EGLDisplay,EGLSurface, EGLint attribute, EGLint *value);
GLAPI EGLBoolean (*eglSwapBuffers)(EGLDisplay,EGLSurface);
GLAPI EGLBoolean (*eglTerminate)(EGLDisplay);
GLAPI EGLBoolean (*eglWaitGL)(void);
GLAPI EGLBoolean (*eglWaitNative)(EGLint engine);

// EGL 1.1 Functions
GLAPI EGLBoolean (*eglBindTexImage)(EGLDisplay,EGLSurface, EGLint buffer);
GLAPI EGLBoolean (*eglReleaseTexImage)(EGLDisplay,EGLSurface, EGLint buffer);
GLAPI EGLBoolean (*eglSurfaceAttrib)(EGLDisplay,EGLSurface, EGLint attribute, EGLint value);
GLAPI EGLBoolean (*eglSwapInterval)(EGLDisplay, EGLint interval);

// EGL 1.2 Functions
GLAPI EGLBoolean (*eglBindAPI)(EGLenum api);
GLAPI EGLenum (*eglQueryAPI)(void);
GLAPI EGLSurface (*eglCreatePbufferFromClientBuffer)(EGLDisplay, EGLenum buftype, EGLClientBuffer buffer, EGLConfig config, const EGLint *attrib_list);
GLAPI EGLBoolean (*eglReleaseThread)(void);
GLAPI EGLBoolean (*eglWaitClient)(void);

// EGL 1.4 Functions
GLAPI EGLContext (*eglGetCurrentContext)(void);
...
typedef void (APIENTRYP PFNEGLSETBLOBCACHEFUNCSANDROIDPROC)(EGLDisplay, EGLSetBlobFuncANDROID set, EGLGetBlobFuncANDROID get);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETCOMPOSITORTIMINGSUPPORTEDANDROIDPROC)(EGLDisplay,EGLSurface, EGLint name);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETCOMPOSITORTIMINGANDROIDPROC)(EGLDisplay,EGLSurface, EGLint numTimestamps, const EGLint *names, EGLnsecsANDROID *values);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETNEXTFRAMEIDANDROIDPROC)(EGLDisplay,EGLSurface, EGLuint64KHR *frameId);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETFRAMETIMESTAMPSUPPORTEDANDROIDPROC)(EGLDisplay,EGLSurface, EGLint timestamp);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETFRAMETIMESTAMPSANDROIDPROC)(EGLDisplay,EGLSurface, EGLuint64KHR frameId, EGLint numTimestamps, const EGLint *timestamps, EGLnsecsANDROID *values);
...
typedef EGLint (APIENTRYP PFNEGLDUPNATIVEFENCEFDANDROIDPROC)(EGLDisplay, EGLSyncKHR sync);
...
typedef EGLBoolean (APIENTRYP PFNEGLPRESENTATIONTIMEANDROIDPROC)(EGLDisplay,EGLSurface, EGLnsecsANDROID time);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSURFACEPOINTERANGLEPROC)(EGLDisplay,EGLSurface, EGLint attribute, void **value);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETMSCRATEANGLEPROC)(EGLDisplay,EGLSurface, EGLint *numerator, EGLint *denominator);
...
typedef EGLBoolean (APIENTRYP PFNEGLCLIENTSIGNALSYNCEXTPROC)(EGLDisplay, EGLSync sync, const EGLAttrib *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYDISPLAYATTRIBEXTPROC)(EGLDisplay, EGLint attribute, EGLAttrib *value);
...
typedef EGLBoolean (APIENTRYP PFNEGLDESTROYDISPLAYEXTPROC)(EGLDisplay);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYDMABUFFORMATSEXTPROC)(EGLDisplay, EGLint max_formats, EGLint *formats, EGLint *num_formats);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYDMABUFMODIFIERSEXTPROC)(EGLDisplay, EGLint format, EGLint max_modifiers, EGLuint64KHR *modifiers, EGLBoolean *external_only, EGLint *num_modifiers);
...
typedef EGLBoolean (APIENTRYP PFNEGLGETOUTPUTLAYERSEXTPROC)(EGLDisplay, const EGLAttrib *attrib_list, EGLOutputLayerEXT *layers, EGLint max_layers, EGLint *num_layers);
GLAPI PFNEGLGETOUTPUTLAYERSEXTPROC glad_eglGetOutputLayersEXT;
#define eglGetOutputLayersEXT glad_eglGetOutputLayersEXT
typedef EGLBoolean (APIENTRYP PFNEGLGETOUTPUTPORTSEXTPROC)(EGLDisplay, const EGLAttrib *attrib_list, EGLOutputPortEXT *ports, EGLint max_ports, EGLint *num_ports);
GLAPI PFNEGLGETOUTPUTPORTSEXTPROC glad_eglGetOutputPortsEXT;
#define eglGetOutputPortsEXT glad_eglGetOutputPortsEXT
typedef EGLBoolean (APIENTRYP PFNEGLOUTPUTLAYERATTRIBEXTPROC)(EGLDisplay, EGLOutputLayerEXT layer, EGLint attribute, EGLAttrib value);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYOUTPUTLAYERATTRIBEXTPROC)(EGLDisplay, EGLOutputLayerEXT layer, EGLint attribute, EGLAttrib *value);
...
typedef const char * (APIENTRYP PFNEGLQUERYOUTPUTLAYERSTRINGEXTPROC)(EGLDisplay, EGLOutputLayerEXT layer, EGLint name);
...
typedef EGLBoolean (APIENTRYP PFNEGLOUTPUTPORTATTRIBEXTPROC)(EGLDisplay, EGLOutputPortEXT port, EGLint attribute, EGLAttrib value);
GLAPI PFNEGLOUTPUTPORTATTRIBEXTPROC glad_eglOutputPortAttribEXT;
#define eglOutputPortAttribEXT glad_eglOutputPortAttribEXT
typedef EGLBoolean (APIENTRYP PFNEGLQUERYOUTPUTPORTATTRIBEXTPROC)(EGLDisplay, EGLOutputPortEXT port, EGLint attribute, EGLAttrib *value);
...
typedef const char * (APIENTRYP PFNEGLQUERYOUTPUTPORTSTRINGEXTPROC)(EGLDisplay, EGLOutputPortEXT port, EGLint name);
...
typedef EGLSurface (APIENTRYP PFNEGLCREATEPLATFORMWINDOWSURFACEEXTPROC)(EGLDisplay, EGLConfig config, void *native_window, const EGLint *attrib_list);
...
typedef EGLSurface (APIENTRYP PFNEGLCREATEPLATFORMPIXMAPSURFACEEXTPROC)(EGLDisplay, EGLConfig config, void *native_pixmap, const EGLint *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMEROUTPUTEXTPROC)(EGLDisplay, EGLStreamKHR stream, EGLOutputLayerEXT layer);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSUPPORTEDCOMPRESSIONRATESEXTPROC)(EGLDisplay, EGLConfig config, const EGLAttrib *attrib_list, EGLint *rates, EGLint rate_size, EGLint *num_rates);
...
typedef EGLBoolean (APIENTRYP PFNEGLSWAPBUFFERSWITHDAMAGEEXTPROC)(EGLDisplay,EGLSurface, const EGLint *rects, EGLint n_rects);
...
typedef EGLBoolean (APIENTRYP PFNEGLUNSIGNALSYNCEXTPROC)(EGLDisplay, EGLSync sync, const EGLAttrib *attrib_list);
...
typedef EGLSurface (APIENTRYP PFNEGLCREATEPIXMAPSURFACEHIPROC)(EGLDisplay, EGLConfig config, struct EGLClientPixmapHI *pixmap);
...
typedef EGLSyncKHR (APIENTRYP PFNEGLCREATESYNC64KHRPROC)(EGLDisplay, EGLenum type, const EGLAttribKHR *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYDISPLAYATTRIBKHRPROC)(EGLDisplay, EGLint name, EGLAttrib *value);
...
typedef EGLSyncKHR (APIENTRYP PFNEGLCREATESYNCKHRPROC)(EGLDisplay, EGLenum type, const EGLint *attrib_list);
GLAPI PFNEGLCREATESYNCKHRPROC glad_eglCreateSyncKHR;
#define eglCreateSyncKHR glad_eglCreateSyncKHR
typedef EGLBoolean (APIENTRYP PFNEGLDESTROYSYNCKHRPROC)(EGLDisplay, EGLSyncKHR sync);
GLAPI PFNEGLDESTROYSYNCKHRPROC glad_eglDestroySyncKHR;
#define eglDestroySyncKHR glad_eglDestroySyncKHR
typedef EGLint (APIENTRYP PFNEGLCLIENTWAITSYNCKHRPROC)(EGLDisplay, EGLSyncKHR sync, EGLint flags, EGLTimeKHR timeout);
GLAPI PFNEGLCLIENTWAITSYNCKHRPROC glad_eglClientWaitSyncKHR;
#define eglClientWaitSyncKHR glad_eglClientWaitSyncKHR
typedef EGLBoolean (APIENTRYP PFNEGLGETSYNCATTRIBKHRPROC)(EGLDisplay, EGLSyncKHR sync, EGLint attribute, EGLint *value);
...
typedef EGLImageKHR (APIENTRYP PFNEGLCREATEIMAGEKHRPROC)(EGLDisplay, EGLContext, EGLenum target, EGLClientBuffer buffer, const EGLint *attrib_list);
GLAPI PFNEGLCREATEIMAGEKHRPROC glad_eglCreateImageKHR;
#define eglCreateImageKHR glad_eglCreateImageKHR
typedef EGLBoolean (APIENTRYP PFNEGLDESTROYIMAGEKHRPROC)(EGLDisplay, EGLImageKHR image);
...
typedef EGLBoolean (APIENTRYP PFNEGLLOCKSURFACEKHRPROC)(EGLDisplay,EGLSurface, const EGLint *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSURFACE64KHRPROC)(EGLDisplay,EGLSurface, EGLint attribute, EGLAttribKHR *value);
...
typedef EGLBoolean (APIENTRYP PFNEGLSETDAMAGEREGIONKHRPROC)(EGLDisplay,EGLSurface, EGLint *rects, EGLint n_rects);
...
typedef EGLBoolean (APIENTRYP PFNEGLSIGNALSYNCKHRPROC)(EGLDisplay, EGLSyncKHR sync, EGLenum mode);
GLAPI PFNEGLSIGNALSYNCKHRPROC glad_eglSignalSyncKHR;
#define eglSignalSyncKHR glad_eglSignalSyncKHR
#endif
#ifndef EGL_KHR_stream
#define EGL_KHR_stream 1
typedef EGLStreamKHR (APIENTRYP PFNEGLCREATESTREAMKHRPROC)(EGLDisplay, const EGLint *attrib_list);
GLAPI PFNEGLCREATESTREAMKHRPROC glad_eglCreateStreamKHR;
#define eglCreateStreamKHR glad_eglCreateStreamKHR
typedef EGLBoolean (APIENTRYP PFNEGLDESTROYSTREAMKHRPROC)(EGLDisplay, EGLStreamKHR stream);
GLAPI PFNEGLDESTROYSTREAMKHRPROC glad_eglDestroyStreamKHR;
#define eglDestroyStreamKHR glad_eglDestroyStreamKHR
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMATTRIBKHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLint value);
GLAPI PFNEGLSTREAMATTRIBKHRPROC glad_eglStreamAttribKHR;
#define eglStreamAttribKHR glad_eglStreamAttribKHR
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSTREAMKHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLint *value);
GLAPI PFNEGLQUERYSTREAMKHRPROC glad_eglQueryStreamKHR;
#define eglQueryStreamKHR glad_eglQueryStreamKHR
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSTREAMU64KHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLuint64KHR *value);
...
typedef EGLStreamKHR (APIENTRYP PFNEGLCREATESTREAMATTRIBKHRPROC)(EGLDisplay, const EGLAttrib *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSETSTREAMATTRIBKHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLAttrib value);
GLAPI PFNEGLSETSTREAMATTRIBKHRPROC glad_eglSetStreamAttribKHR;
#define eglSetStreamAttribKHR glad_eglSetStreamAttribKHR
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSTREAMATTRIBKHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLAttrib *value);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERACQUIREATTRIBKHRPROC)(EGLDisplay, EGLStreamKHR stream, const EGLAttrib *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERRELEASEATTRIBKHRPROC)(EGLDisplay, EGLStreamKHR stream, const EGLAttrib *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERGLTEXTUREEXTERNALKHRPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERACQUIREKHRPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERRELEASEKHRPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLNativeFileDescriptorKHR (APIENTRYP PFNEGLGETSTREAMFILEDESCRIPTORKHRPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLStreamKHR (APIENTRYP PFNEGLCREATESTREAMFROMFILEDESCRIPTORKHRPROC)(EGLDisplay, EGLNativeFileDescriptorKHR file_descriptor);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSTREAMTIMEKHRPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum attribute, EGLTimeKHR *value);
...
typedef EGLSurface (APIENTRYP PFNEGLCREATESTREAMPRODUCERSURFACEKHRPROC)(EGLDisplay, EGLConfig config, EGLStreamKHR stream, const EGLint *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSWAPBUFFERSWITHDAMAGEKHRPROC)(EGLDisplay,EGLSurface, const EGLint *rects, EGLint n_rects);
...
typedef EGLint (APIENTRYP PFNEGLWAITSYNCKHRPROC)(EGLDisplay, EGLSyncKHR sync, EGLint flags);
GLAPI PFNEGLWAITSYNCKHRPROC glad_eglWaitSyncKHR;
#define eglWaitSyncKHR glad_eglWaitSyncKHR
#endif
#ifndef EGL_MESA_drm_image
#define EGL_MESA_drm_image 1
typedef EGLImageKHR (APIENTRYP PFNEGLCREATEDRMIMAGEMESAPROC)(EGLDisplay, const EGLint *attrib_list);
GLAPI PFNEGLCREATEDRMIMAGEMESAPROC glad_eglCreateDRMImageMESA;
#define eglCreateDRMImageMESA glad_eglCreateDRMImageMESA
typedef EGLBoolean (APIENTRYP PFNEGLEXPORTDRMIMAGEMESAPROC)(EGLDisplay, EGLImageKHR image, EGLint *name, EGLint *handle, EGLint *stride);
...
typedef EGLBoolean (APIENTRYP PFNEGLEXPORTDMABUFIMAGEQUERYMESAPROC)(EGLDisplay, EGLImageKHR image, int *fourcc, int *num_planes, EGLuint64KHR *modifiers);
...
typedef EGLBoolean (APIENTRYP PFNEGLEXPORTDMABUFIMAGEMESAPROC)(EGLDisplay, EGLImageKHR image, int *fds, EGLint *strides, EGLint *offsets);
...
typedef char * (APIENTRYP PFNEGLGETDISPLAYDRIVERCONFIGPROC)(EGLDisplay);
...
typedef const char * (APIENTRYP PFNEGLGETDISPLAYDRIVERNAMEPROC)(EGLDisplay);
...
typedef EGLBoolean (APIENTRYP PFNEGLSWAPBUFFERSREGIONNOKPROC)(EGLDisplay,EGLSurface, EGLint numRects, const EGLint *rects);
...
typedef EGLBoolean (APIENTRYP PFNEGLSWAPBUFFERSREGION2NOKPROC)(EGLDisplay,EGLSurface, EGLint numRects, const EGLint *rects);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYNATIVEDISPLAYNVPROC)(EGLDisplay, EGLNativeDisplayType *display_id);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYNATIVEWINDOWNVPROC)(EGLDisplay, EGLSurface surf, EGLNativeWindowType *window);
GLAPI PFNEGLQUERYNATIVEWINDOWNVPROC glad_eglQueryNativeWindowNV;
#define eglQueryNativeWindowNV glad_eglQueryNativeWindowNV
typedef EGLBoolean (APIENTRYP PFNEGLQUERYNATIVEPIXMAPNVPROC)(EGLDisplay, EGLSurface surf, EGLNativePixmapType *pixmap);
...
typedef EGLBoolean (APIENTRYP PFNEGLPOSTSUBBUFFERNVPROC)(EGLDisplay,EGLSurface, EGLint x, EGLint y, EGLint width, EGLint height);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMIMAGECONSUMERCONNECTNVPROC)(EGLDisplay, EGLStreamKHR stream, EGLint num_modifiers, const EGLuint64KHR *modifiers, const EGLAttrib *attrib_list);
...
typedef EGLint (APIENTRYP PFNEGLQUERYSTREAMCONSUMEREVENTNVPROC)(EGLDisplay, EGLStreamKHR stream, EGLTime timeout, EGLenum *event, EGLAttrib *aux);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMACQUIREIMAGENVPROC)(EGLDisplay, EGLStreamKHR stream, EGLImage *pImage, EGLSync sync);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMRELEASEIMAGENVPROC)(EGLDisplay, EGLStreamKHR stream, EGLImage image, EGLSync sync);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMCONSUMERGLTEXTUREEXTERNALATTRIBSNVPROC)(EGLDisplay, EGLStreamKHR stream, const EGLAttrib *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLSTREAMFLUSHNVPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYDISPLAYATTRIBNVPROC)(EGLDisplay, EGLint attribute, EGLAttrib *value);
...
typedef EGLBoolean (APIENTRYP PFNEGLSETSTREAMMETADATANVPROC)(EGLDisplay, EGLStreamKHR stream, EGLint n, EGLint offset, EGLint size, const void *data);
GLAPI PFNEGLSETSTREAMMETADATANVPROC glad_eglSetStreamMetadataNV;
#define eglSetStreamMetadataNV glad_eglSetStreamMetadataNV
typedef EGLBoolean (APIENTRYP PFNEGLQUERYSTREAMMETADATANVPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum name, EGLint n, EGLint offset, EGLint size, void *data);
...
typedef EGLBoolean (APIENTRYP PFNEGLRESETSTREAMNVPROC)(EGLDisplay, EGLStreamKHR stream);
...
typedef EGLSyncKHR (APIENTRYP PFNEGLCREATESTREAMSYNCNVPROC)(EGLDisplay, EGLStreamKHR stream, EGLenum type, const EGLint *attrib_list);
GLAPI PFNEGLCREATESTREAMSYNCNVPROC glad_eglCreateStreamSyncNV;
#define eglCreateStreamSyncNV glad_eglCreateStreamSyncNV
#endif
#ifndef EGL_NV_sync
#define EGL_NV_sync 1
typedef EGLSyncNV (APIENTRYP PFNEGLCREATEFENCESYNCNVPROC)(EGLDisplay, EGLenum condition, const EGLint *attrib_list);
...
typedef EGLBoolean (APIENTRYP PFNEGLBINDWAYLANDDISPLAYWLPROC)(EGLDisplay, struct wl_display *display);
...
typedef EGLBoolean (APIENTRYP PFNEGLUNBINDWAYLANDDISPLAYWLPROC)(EGLDisplay, struct wl_display *display);
...
typedef EGLBoolean (APIENTRYP PFNEGLQUERYWAYLANDBUFFERWLPROC)(EGLDisplay, struct wl_resource *buffer, EGLint attribute, EGLint *value);
...
typedef struct wl_buffer * (APIENTRYP PFNEGLCREATEWAYLANDBUFFERFROMIMAGEWLPROC)(EGLDisplay, EGLImageKHR image);
