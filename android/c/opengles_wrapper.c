...
#define LOADFUNCT(X)          \
  ...
  if (!temp)                  \
    goto load_gles_err;
  // --- GL ES 2.0 Core Functions ---
  glActiveTexture = (void (*)(GLenum))LOADFUNCT(gleslib, "glActiveTexture");
  glAttachShader = (void (*)(GLuint, GLuint))LOADFUNCT(gleslib, "glAttachShader");
  glBindAttribLocation = (void (*)(GLuint, GLuint, const GLchar *))LOADFUNCT(gleslib, "glBindAttribLocation");
  glBindBuffer = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBindBuffer");
  glBindFramebuffer = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBindFramebuffer");
  glBindRenderbuffer = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBindRenderbuffer");
  glBindTexture = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBindTexture");
  glBlendColor = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glBlendColor");
  glBlendEquation = (void (*)(GLenum))LOADFUNCT(gleslib, "glBlendEquation");
  glBlendEquationSeparate = (void (*)(GLenum, GLenum))LOADFUNCT(gleslib, "glBlendEquationSeparate");
  glBlendFunc = (void (*)(GLenum, GLenum))LOADFUNCT(gleslib, "glBlendFunc");
  glBlendFuncSeparate = (void (*)(GLenum, GLenum, GLenum, GLenum))LOADFUNCT(gleslib, "glBlendFuncSeparate");
  glClear = (void (*)(GLbitfield))LOADFUNCT(gleslib, "glClear");
  glClearColor = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glClearColor");
  glClearDepthf = (void (*)(GLfloat))LOADFUNCT(gleslib, "glClearDepthf");
  glClearStencil = (void (*)(GLint))LOADFUNCT(gleslib, "glClearStencil");
  glColorMask = (void (*)(GLboolean, GLboolean, GLboolean, GLboolean))LOADFUNCT(gleslib, "glColorMask");
  glCompileShader = (void (*)(GLuint))LOADFUNCT(gleslib, "glCompileShader");
  glCompressedTexImage2D = (void (*)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const void *))LOADFUNCT(gleslib, "glCompressedTexImage2D");
  glCompressedTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void *))LOADFUNCT(gleslib, "glCompressedTexSubImage2D");
  glCopyTexImage2D = (void (*)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint))LOADFUNCT(gleslib, "glCopyTexImage2D");
  glCopyTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))LOADFUNCT(gleslib, "glCopyTexSubImage2D");
  glCreateProgram = (GLuint(*)(void))LOADFUNCT(gleslib, "glCreateProgram");
  glCreateShader = (GLuint(*)(GLenum))LOADFUNCT(gleslib, "glCreateShader");
  glCullFace = (void (*)(GLenum))LOADFUNCT(gleslib, "glCullFace");
  glDeleteBuffers = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteBuffers");
  glDeleteFramebuffers = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteFramebuffers");
  glDeleteProgram = (void (*)(GLuint))LOADFUNCT(gleslib, "glDeleteProgram");
  glDeleteRenderbuffers = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteRenderbuffers");
  glDeleteShader = (void (*)(GLuint))LOADFUNCT(gleslib, "glDeleteShader");
  glDeleteTextures = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteTextures");
  glDepthFunc = (void (*)(GLenum))LOADFUNCT(gleslib, "glDepthFunc");
  glDepthMask = (void (*)(GLboolean))LOADFUNCT(gleslib, "glDepthMask");
  glDepthRangef = (void (*)(GLfloat, GLfloat))LOADFUNCT(gleslib, "glDepthRangef");
  glDetachShader = (void (*)(GLuint, GLuint))LOADFUNCT(gleslib, "glDetachShader");
  glDisable = (void (*)(GLenum))LOADFUNCT(gleslib, "glDisable");
  glDisableVertexAttribArray = (void (*)(GLuint))LOADFUNCT(gleslib, "glDisableVertexAttribArray");
  glDrawArrays = (void (*)(GLenum, GLint, GLsizei))LOADFUNCT(gleslib, "glDrawArrays");
  glDrawElements = (void (*)(GLenum, GLsizei, GLenum, const void *))LOADFUNCT(gleslib, "glDrawElements");
  glEnable = (void (*)(GLenum))LOADFUNCT(gleslib, "glEnable");
  glEnableVertexAttribArray = (void (*)(GLuint))LOADFUNCT(gleslib, "glEnableVertexAttribArray");
  glFinish = (void (*)(void))LOADFUNCT(gleslib, "glFinish");
  glFlush = (void (*)(void))LOADFUNCT(gleslib, "glFlush");
  glFramebufferRenderbuffer = (void (*)(GLenum, GLenum, GLenum, GLuint))LOADFUNCT(gleslib, "glFramebufferRenderbuffer");
  glFramebufferTexture2D = (void (*)(GLenum, GLenum, GLenum, GLuint, GLint))LOADFUNCT(gleslib, "glFramebufferTexture2D");
  glFrontFace = (void (*)(GLenum))LOADFUNCT(gleslib, "glFrontFace");
  glGenBuffers = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenBuffers");
  glGenerateMipmap = (void (*)(GLenum))LOADFUNCT(gleslib, "glGenerateMipmap");
  glGenFramebuffers = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenFramebuffers");
  glGenRenderbuffers = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenRenderbuffers");
  glGenTextures = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenTextures");
  glGetActiveAttrib = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *))LOADFUNCT(gleslib, "glGetActiveAttrib");
  glGetActiveUniform = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *))LOADFUNCT(gleslib, "glGetActiveUniform");
  glGetAttachedShaders = (void (*)(GLuint, GLsizei, GLsizei *, GLuint *))LOADFUNCT(gleslib, "glGetAttachedShaders");
  glGetAttribLocation = (GLint(*)(GLuint, const GLchar *))LOADFUNCT(gleslib, "glGetAttribLocation");
  glGetBooleanv = (void (*)(GLenum, GLboolean *))LOADFUNCT(gleslib, "glGetBooleanv");
  glGetBufferParameteriv = (void (*)(GLenum, GLenum, GLint *))LOADFUNCT(gleslib, "glGetBufferParameteriv");
  glGetError = (GLenum(*)(void))LOADFUNCT(gleslib, "glGetError");
  glGetFloatv = (void (*)(GLenum, GLfloat *))LOADFUNCT(gleslib, "glGetFloatv");
  glGetFramebufferAttachmentParameteriv = (void (*)(GLenum, GLenum, GLenum, GLint *))LOADFUNCT(gleslib, "glGetFramebufferAttachmentParameteriv");
  glGetIntegerv = (void (*)(GLenum, GLint *))LOADFUNCT(gleslib, "glGetIntegerv");
  glGetProgramiv = (void (*)(GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetProgramiv");
  glGetProgramInfoLog = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetProgramInfoLog");
  glGetRenderbufferParameteriv = (void (*)(GLenum, GLenum, GLint *))LOADFUNCT(gleslib, "glGetRenderbufferParameteriv");
  glGetShaderiv = (void (*)(GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetShaderiv");
  glGetShaderInfoLog = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetShaderInfoLog");
  glGetShaderPrecisionFormat = (void (*)(GLenum, GLenum, GLint *, GLint *))LOADFUNCT(gleslib, "glGetShaderPrecisionFormat");
  glGetShaderSource = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetShaderSource");
  glGetString = (const GLubyte *(*)(GLenum))LOADFUNCT(gleslib, "glGetString");
  glGetTexParameterfv = (void (*)(GLenum, GLenum, GLfloat *))LOADFUNCT(gleslib, "glGetTexParameterfv");
  glGetTexParameteriv = (void (*)(GLenum, GLenum, GLint *))LOADFUNCT(gleslib, "glGetTexParameteriv");
  glGetUniformLocation = (GLint(*)(GLuint, const GLchar *))LOADFUNCT(gleslib, "glGetUniformLocation");
  glGetUniformfv = (void (*)(GLuint, GLint, GLfloat *))LOADFUNCT(gleslib, "glGetUniformfv");
  glGetUniformiv = (void (*)(GLuint, GLint, GLint *))LOADFUNCT(gleslib, "glGetUniformiv");
  glGetVertexAttribfv = (void (*)(GLuint, GLenum, GLfloat *))LOADFUNCT(gleslib, "glGetVertexAttribfv");
  glGetVertexAttribiv = (void (*)(GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetVertexAttribiv");
  glGetVertexAttribPointerv = (void (*)(GLuint, GLenum, void **))LOADFUNCT(gleslib, "glGetVertexAttribPointerv");
  glHint = (void (*)(GLenum, GLenum))LOADFUNCT(gleslib, "glHint");
  glIsBuffer = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsBuffer");
  glIsEnabled = (GLboolean(*)(GLenum))LOADFUNCT(gleslib, "glIsEnabled");
  glIsFramebuffer = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsFramebuffer");
  glIsProgram = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsProgram");
  glIsRenderbuffer = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsRenderbuffer");
  glIsShader = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsShader");
  glIsTexture = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsTexture");
  glLineWidth = (void (*)(GLfloat))LOADFUNCT(gleslib, "glLineWidth");
  glLinkProgram = (void (*)(GLuint))LOADFUNCT(gleslib, "glLinkProgram");
  glPixelStorei = (void (*)(GLenum, GLint))LOADFUNCT(gleslib, "glPixelStorei");
  glPolygonOffset = (void (*)(GLfloat, GLfloat))LOADFUNCT(gleslib, "glPolygonOffset");
  glReadPixels = (void (*)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *))LOADFUNCT(gleslib, "glReadPixels");
  glReleaseShaderCompiler = (void (*)(void))LOADFUNCT(gleslib, "glReleaseShaderCompiler");
  glRenderbufferStorage = (void (*)(GLenum, GLenum, GLsizei, GLsizei))LOADFUNCT(gleslib, "glRenderbufferStorage");
  glSampleCoverage = (void (*)(GLfloat, GLboolean))LOADFUNCT(gleslib, "glSampleCoverage");
  glScissor = (void (*)(GLint, GLint, GLsizei, GLsizei))LOADFUNCT(gleslib, "glScissor");
  glShaderBinary = (void (*)(GLsizei, const GLuint *, GLenum, const void *, GLsizei))LOADFUNCT(gleslib, "glShaderBinary");
  glShaderSource = (void (*)(GLuint, GLsizei, const GLchar *const *, const GLint *))LOADFUNCT(gleslib, "glShaderSource");
  glStencilFunc = (void (*)(GLenum, GLint, GLuint))LOADFUNCT(gleslib, "glStencilFunc");
  glStencilFuncSeparate = (void (*)(GLenum, GLenum, GLint, GLuint))LOADFUNCT(gleslib, "glStencilFuncSeparate");
  glStencilMask = (void (*)(GLuint))LOADFUNCT(gleslib, "glStencilMask");
  glStencilMaskSeparate = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glStencilMaskSeparate");
  glStencilOp = (void (*)(GLenum, GLenum, GLenum))LOADFUNCT(gleslib, "glStencilOp");
  glStencilOpSeparate = (void (*)(GLenum, GLenum, GLenum, GLenum))LOADFUNCT(gleslib, "glStencilOpSeparate");
  glTexImage2D = (void (*)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *))LOADFUNCT(gleslib, "glTexImage2D");
  glTexParameterf = (void (*)(GLenum, GLenum, GLfloat))LOADFUNCT(gleslib, "glTexParameterf");
  glTexParameterfv = (void (*)(GLenum, GLenum, const GLfloat *))LOADFUNCT(gleslib, "glTexParameterfv");
  glTexParameteri = (void (*)(GLenum, GLenum, GLint))LOADFUNCT(gleslib, "glTexParameteri");
  glTexParameteriv = (void (*)(GLenum, GLenum, const GLint *))LOADFUNCT(gleslib, "glTexParameteriv");
  glTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void *))LOADFUNCT(gleslib, "glTexSubImage2D");
  glUniform1f = (void (*)(GLint, GLfloat))LOADFUNCT(gleslib, "glUniform1f");
  glUniform1fv = (void (*)(GLint, GLsizei, const GLfloat *))LOADFUNCT(gleslib, "glUniform1fv");
  glUniform1i = (void (*)(GLint, GLint))LOADFUNCT(gleslib, "glUniform1i");
  glUniform1iv = (void (*)(GLint, GLsizei, const GLint *))LOADFUNCT(gleslib, "glUniform1iv");
  glUniform2f = (void (*)(GLint, GLfloat, GLfloat))LOADFUNCT(gleslib, "glUniform2f");
  glUniform2fv = (void (*)(GLint, GLsizei, const GLfloat *))LOADFUNCT(gleslib, "glUniform2fv");
  glUniform2i = (void (*)(GLint, GLint, GLint))LOADFUNCT(gleslib, "glUniform2i");
  glUniform2iv = (void (*)(GLint, GLsizei, const GLint *))LOADFUNCT(gleslib, "glUniform2iv");
  glUniform3f = (void (*)(GLint, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glUniform3f");
  glUniform3fv = (void (*)(GLint, GLsizei, const GLfloat *))LOADFUNCT(gleslib, "glUniform3fv");
  glUniform3i = (void (*)(GLint, GLint, GLint, GLint))LOADFUNCT(gleslib, "glUniform3i");
  glUniform3iv = (void (*)(GLint, GLsizei, const GLint *))LOADFUNCT(gleslib, "glUniform3iv");
  glUniform4f = (void (*)(GLint, GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glUniform4f");
  glUniform4fv = (void (*)(GLint, GLsizei, const GLfloat *))LOADFUNCT(gleslib, "glUniform4fv");
  glUniform4i = (void (*)(GLint, GLint, GLint, GLint, GLint))LOADFUNCT(gleslib, "glUniform4i");
  glUniform4iv = (void (*)(GLint, GLsizei, const GLint *))LOADFUNCT(gleslib, "glUniform4iv");
  glUniformMatrix2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix2fv");
  glUniformMatrix3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix3fv");
  glUniformMatrix4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix4fv");
  glUseProgram = (void (*)(GLuint))LOADFUNCT(gleslib, "glUseProgram");
  glValidateProgram = (void (*)(GLuint))LOADFUNCT(gleslib, "glValidateProgram");
  glVertexAttrib1f = (void (*)(GLuint, GLfloat))LOADFUNCT(gleslib, "glVertexAttrib1f");
  glVertexAttrib1fv = (void (*)(GLuint, const GLfloat *))LOADFUNCT(gleslib, "glVertexAttrib1fv");
  glVertexAttrib2f = (void (*)(GLuint, GLfloat, GLfloat))LOADFUNCT(gleslib, "glVertexAttrib2f");
  glVertexAttrib2fv = (void (*)(GLuint, const GLfloat *))LOADFUNCT(gleslib, "glVertexAttrib2fv");
  glVertexAttrib3f = (void (*)(GLuint, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glVertexAttrib3f");
  glVertexAttrib3fv = (void (*)(GLuint, const GLfloat *))LOADFUNCT(gleslib, "glVertexAttrib3fv");
  glVertexAttrib4f = (void (*)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glVertexAttrib4f");
  glVertexAttrib4fv = (void (*)(GLuint, const GLfloat *))LOADFUNCT(gleslib, "glVertexAttrib4fv");
  glVertexAttribPointer = (void (*)(GLuint, GLint, GLenum, GLboolean, GLsizei, const void *))LOADFUNCT(gleslib, "glVertexAttribPointer");
  glViewport = (void (*)(GLint, GLint, GLsizei, GLsizei))LOADFUNCT(gleslib, "glViewport");
  glBufferData = (void (*)(GLenum, GLsizeiptr, const void *, GLenum))LOADFUNCT(gleslib, "glBufferData");
  glBufferSubData = (void (*)(GLenum, GLintptr, GLsizeiptr, const void *))LOADFUNCT(gleslib, "glBufferSubData");

  // --- GL ES 3.0 Core Functions ---
  glReadBuffer = (void (*)(GLenum))LOADFUNCT(gleslib, "glReadBuffer");
  glDrawRangeElements = (void (*)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *))LOADFUNCT(gleslib, "glDrawRangeElements");
  glTexImage3D = (void (*)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *))LOADFUNCT(gleslib, "glTexImage3D");
  glTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *))LOADFUNCT(gleslib, "glTexSubImage3D");
  glCopyTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))LOADFUNCT(gleslib, "glCopyTexSubImage3D");
  glCompressedTexImage3D = (void (*)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const void *))LOADFUNCT(gleslib, "glCompressedTexImage3D");
  glCompressedTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *))LOADFUNCT(gleslib, "glCompressedTexSubImage3D");
  glGenQueries = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenQueries");
  glDeleteQueries = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteQueries");
  glIsQuery = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsQuery");
  glBeginQuery = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBeginQuery");
  glEndQuery = (void (*)(GLenum))LOADFUNCT(gleslib, "glEndQuery");
  glGetQueryiv = (void (*)(GLenum, GLenum, GLint *))LOADFUNCT(gleslib, "glGetQueryiv");
  glGetQueryObjectuiv = (void (*)(GLuint, GLenum, GLuint *))LOADFUNCT(gleslib, "glGetQueryObjectuiv");
  glUnmapBuffer = (void (*)(GLenum))LOADFUNCT(gleslib, "glUnmapBuffer");
  glMapBufferRange = (const void *(*)(GLenum, GLintptr, GLsizeiptr, GLbitfield))LOADFUNCT(gleslib, "glMapBufferRange");
  glFlushMappedBufferRange = (void (*)(GLenum, GLintptr, GLsizeiptr))LOADFUNCT(gleslib, "glFlushMappedBufferRange");
  glGenSamplers = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenSamplers");
  glDeleteSamplers = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteSamplers");
  glIsSampler = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsSampler");
  glBindSampler = (void (*)(GLuint, GLuint))LOADFUNCT(gleslib, "glBindSampler");
  glSamplerParameterf = (void (*)(GLuint, GLenum, GLfloat))LOADFUNCT(gleslib, "glSamplerParameterf");
  glSamplerParameterfv = (void (*)(GLuint, GLenum, const GLfloat *))LOADFUNCT(gleslib, "glSamplerParameterfv");
  glSamplerParameteri = (void (*)(GLuint, GLenum, GLint))LOADFUNCT(gleslib, "glSamplerParameteri");
  glSamplerParameteriv = (void (*)(GLuint, GLenum, const GLint *))LOADFUNCT(gleslib, "glSamplerParameteriv");
  glGetSamplerParameterfv = (void (*)(GLuint, GLenum, GLfloat *))LOADFUNCT(gleslib, "glGetSamplerParameterfv");
  glGetSamplerParameteriv = (void (*)(GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetSamplerParameteriv");
  glVertexAttribDivisor = (void (*)(GLuint, GLuint))LOADFUNCT(gleslib, "glVertexAttribDivisor");
  glBindTransformFeedback = (void (*)(GLenum, GLuint))LOADFUNCT(gleslib, "glBindTransformFeedback");
  glDeleteTransformFeedbacks = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteTransformFeedbacks");
  glIsTransformFeedback = (GLboolean(*)(GLuint))LOADFUNCT(gleslib, "glIsTransformFeedback");
  glGenTransformFeedbacks = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenTransformFeedbacks");
  glPauseTransformFeedback = (void (*)(void))LOADFUNCT(gleslib, "glPauseTransformFeedback");
  glResumeTransformFeedback = (void (*)(void))LOADFUNCT(gleslib, "glResumeTransformFeedback");
  glBeginTransformFeedback = (void (*)(GLenum))LOADFUNCT(gleslib, "glBeginTransformFeedback");
  glEndTransformFeedback = (void (*)(void))LOADFUNCT(gleslib, "glEndTransformFeedback");
  glTransformFeedbackVaryings = (void (*)(GLuint, GLsizei, const GLchar *const *, GLenum))LOADFUNCT(gleslib, "glTransformFeedbackVaryings");
  glGetTransformFeedbackVarying = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, GLchar *))LOADFUNCT(gleslib, "glGetTransformFeedbackVarying");
  glBindBufferRange = (void (*)(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr))LOADFUNCT(gleslib, "glBindBufferRange");
  glBindBufferBase = (void (*)(GLenum, GLuint, GLuint))LOADFUNCT(gleslib, "glBindBufferBase");
  glGetActiveUniformBlockName = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetActiveUniformBlockName");
  glGetActiveUniformBlockiv = (void (*)(GLuint, GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetActiveUniformBlockiv");
  glGetUniformBlockIndex = (void (*)(GLuint, const GLchar *))LOADFUNCT(gleslib, "glGetUniformBlockIndex");
  glUniformBlockBinding = (void (*)(GLuint, GLuint, GLuint))LOADFUNCT(gleslib, "glUniformBlockBinding");
  glGetUniformIndices = (void (*)(GLuint, GLsizei, const GLchar *const *, GLuint *))LOADFUNCT(gleslib, "glGetUniformIndices");
  glGetActiveUniformsiv = (void (*)(GLuint, GLsizei, const GLuint *, GLenum, GLint *))LOADFUNCT(gleslib, "glGetActiveUniformsiv");
  glFenceSync = (GLsync(*)(GLenum, GLbitfield))LOADFUNCT(gleslib, "glFenceSync");
  glIsSync = (GLboolean(*)(GLsync))LOADFUNCT(gleslib, "glIsSync");
  glDeleteSync = (void (*)(GLsync))LOADFUNCT(gleslib, "glDeleteSync");
  glClientWaitSync = (GLenum(*)(GLsync, GLbitfield, GLuint64))LOADFUNCT(gleslib, "glClientWaitSync");
  glWaitSync = (void (*)(GLsync, GLbitfield, GLuint64))LOADFUNCT(gleslib, "glWaitSync");
  glGetInteger64v = (void (*)(GLenum, GLint64 *))LOADFUNCT(gleslib, "glGetInteger64v");
  glGetSynciv = (void (*)(GLsync, GLenum, GLsizei, GLsizei *, GLint *))LOADFUNCT(gleslib, "glGetSynciv");
  glCopyBufferSubData = (void (*)(GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr))LOADFUNCT(gleslib, "glCopyBufferSubData");
  glGetBufferParameteri64v = (void (*)(GLenum, GLenum, GLint64 *))LOADFUNCT(gleslib, "glGetBufferParameteri64v");
  glBlitFramebuffer = (void (*)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum))LOADFUNCT(gleslib, "glBlitFramebuffer");
  glCheckFramebufferStatus = (GLenum(*)(GLenum))LOADFUNCT(gleslib, "glCheckFramebufferStatus");
  glDrawArraysInstanced = (void (*)(GLenum, GLint, GLsizei, GLsizei))LOADFUNCT(gleslib, "glDrawArraysInstanced");
  glDrawElementsInstanced = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei))LOADFUNCT(gleslib, "glDrawElementsInstanced");
  glFramebufferTextureLayer = (void (*)(GLenum, GLenum, GLuint, GLint, GLint))LOADFUNCT(gleslib, "glFramebufferTextureLayer");
  glGetIntegeri_v = (void (*)(GLenum, GLuint, GLint *))LOADFUNCT(gleslib, "glGetIntegeri_v");
  glGetProgramBinary = (void (*)(GLuint, GLsizei, GLsizei *, GLenum *, void *))LOADFUNCT(gleslib, "glGetProgramBinary");
  glGetStringi = (const GLubyte *(*)(GLenum, GLuint))LOADFUNCT(gleslib, "glGetStringi");
  glProgramBinary = (void (*)(GLuint, GLenum, const void *, GLsizei))LOADFUNCT(gleslib, "glProgramBinary");
  glProgramParameteri = (void (*)(GLuint, GLenum, GLint))LOADFUNCT(gleslib, "glProgramParameteri");
  glTexStorage2D = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei))LOADFUNCT(gleslib, "glTexStorage2D");
  glTexStorage3D = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei))LOADFUNCT(gleslib, "glTexStorage3D");
  glUniformMatrix2x3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix2x3fv");
  glUniformMatrix3x2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix3x2fv");
  glUniformMatrix2x4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix2x4fv");
  glUniformMatrix4x2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix4x2fv");
  glUniformMatrix3x4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix3x4fv");
  glUniformMatrix4x3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))LOADFUNCT(gleslib, "glUniformMatrix4x3fv");
  glVertexAttribI4i = (void (*)(GLuint, GLint, GLint, GLint, GLint))LOADFUNCT(gleslib, "glVertexAttribI4i");
  glVertexAttribI4iv = (void (*)(GLuint, const GLint *))LOADFUNCT(gleslib, "glVertexAttribI4iv");
  glVertexAttribI4ui = (void (*)(GLuint, GLuint, GLuint, GLuint, GLuint))LOADFUNCT(gleslib, "glVertexAttribI4ui");
  glVertexAttribI4uiv = (void (*)(GLuint, const GLuint *))LOADFUNCT(gleslib, "glVertexAttribI4uiv");
  glVertexAttribIPointer = (void (*)(GLuint, GLint, GLenum, GLsizei, const void *))LOADFUNCT(gleslib, "glVertexAttribIPointer");
  glGetVertexAttribIiv = (void (*)(GLuint, GLenum, GLint *))LOADFUNCT(gleslib, "glGetVertexAttribIiv");
  glGetVertexAttribIuiv = (void (*)(GLuint, GLenum, GLuint *))LOADFUNCT(gleslib, "glGetVertexAttribIuiv");
  glGetFragDataLocation = (GLint(*)(GLuint, const GLchar *))LOADFUNCT(gleslib, "glGetFragDataLocation");
  glGenVertexArrays = (void (*)(GLsizei, GLuint *))LOADFUNCT(gleslib, "glGenVertexArrays");
  glBindVertexArray = (void (*)(GLuint))LOADFUNCT(gleslib, "glBindVertexArray");
  glDeleteVertexArrays = (void (*)(GLsizei, const GLuint *))LOADFUNCT(gleslib, "glDeleteVertexArrays");

  // --- GL ES 3.1 Core Functions ---
  glDispatchCompute = (void (*)(GLuint, GLuint, GLuint))LOADFUNCT(gleslib, "glDispatchCompute");
  glDispatchComputeIndirect = (void (*)(GLintptr))LOADFUNCT(gleslib, "glDispatchComputeIndirect");
  glDrawArraysIndirect = (void (*)(GLenum, const void *))LOADFUNCT(gleslib, "glDrawArraysIndirect");
  glDrawElementsIndirect = (void (*)(GLenum, GLenum, const void *))LOADFUNCT(gleslib, "glDrawElementsIndirect");
  glFramebufferTexture = (void (*)(GLenum, GLenum, GLuint, GLint))LOADFUNCT(gleslib, "glFramebufferTexture");
  glGetProgramResourceIndex = (void (*)(GLuint, GLenum, const GLchar *))LOADFUNCT(gleslib, "glGetProgramResourceIndex");
  glGetProgramResourceName = (void (*)(GLuint, GLenum, GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetProgramResourceName");
  glGetProgramResourceiv = (void (*)(GLuint, GLenum, GLuint, GLsizei, const GLenum *, GLsizei, GLsizei *, GLint *))LOADFUNCT(gleslib, "glGetProgramResourceiv");
  glGetProgramResourceLocation = (GLint(*)(GLuint, GLenum, const GLchar *))LOADFUNCT(gleslib, "glGetProgramResourceLocation");
  glShaderStorageBlockBinding = (void (*)(GLuint, GLuint, GLuint))LOADFUNCT(gleslib, "glShaderStorageBlockBinding");
  glTexBuffer = (void (*)(GLenum, GLenum, GLuint))LOADFUNCT(gleslib, "glTexBuffer");
  glTexBufferRange = (void (*)(GLenum, GLenum, GLuint, GLintptr, GLsizeiptr))LOADFUNCT(gleslib, "glTexBufferRange");
  glTexImage2DMultisample = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean))LOADFUNCT(gleslib, "glTexImage2DMultisample");

  // --- GL ES 3.2 Core Functions ---
  glBlendBarrier = (void (*)(void))LOADFUNCT(gleslib, "glBlendBarrier"); // Also an extension
  glDebugMessageControl = (void (*)(GLenum, GLenum, GLenum, GLsizei, const GLuint *, GLboolean))LOADFUNCT(gleslib, "glDebugMessageControl");
  glDebugMessageInsert = (void (*)(GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *))LOADFUNCT(gleslib, "glDebugMessageInsert");
  glDebugMessageCallback = (void (*)(GLDEBUGPROC, const void *))LOADFUNCT(gleslib, "glDebugMessageCallback");
  glGetDebugMessageLog = (GLuint(*)(GLuint, GLsizei, GLenum *, GLenum *, GLuint *, GLenum *, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetDebugMessageLog");
  glPushDebugGroup = (void (*)(GLenum, GLuint, GLsizei, const GLchar *))LOADFUNCT(gleslib, "glPushDebugGroup");
  glPopDebugGroup = (void (*)(void))LOADFUNCT(gleslib, "glPopDebugGroup");
  glObjectLabel = (void (*)(GLenum, GLuint, GLsizei, const GLchar *))LOADFUNCT(gleslib, "glObjectLabel");
  glGetObjectLabel = (void (*)(GLenum, GLuint, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetObjectLabel");
  glObjectPtrLabel = (void (*)(const void *, GLsizei, const GLchar *))LOADFUNCT(gleslib, "glObjectPtrLabel");
  glGetObjectPtrLabel = (void (*)(const void *, GLsizei, GLsizei *, GLchar *))LOADFUNCT(gleslib, "glGetObjectPtrLabel");
  glGetPointerv = (void (*)(GLenum, void **))LOADFUNCT(gleslib, "glGetPointerv");
  glPrimitiveBoundingBoxEXT = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glPrimitiveBoundingBoxEXT"); // Also core in 3.2
  glPatchParameteriEXT = (void (*)(GLenum, GLint))LOADFUNCT(gleslib, "glPatchParameteriEXT");                                                                    // Also core in 3.2
  glDrawElementsBaseVertex = (void (*)(GLenum, GLsizei, GLenum, const void *, GLint))LOADFUNCT(gleslib, "glDrawElementsBaseVertex");
  glDrawRangeElementsBaseVertex = (void (*)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *, GLint))LOADFUNCT(gleslib, "glDrawRangeElementsBaseVertex");
  glDrawElementsInstancedBaseVertex = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei, GLint))LOADFUNCT(gleslib, "glDrawElementsInstancedBaseVertex");
  glDrawElementsInstancedBaseInstanceEXT = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei, GLuint))LOADFUNCT(gleslib, "glDrawElementsInstancedBaseInstanceEXT");
  glPrimitiveBoundingBox = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat))LOADFUNCT(gleslib, "glPrimitiveBoundingBox");
  glPatchParameteri = (void (*)(GLenum, GLint))LOADFUNCT(gleslib, "glPatchParameteri");
