...
static inline void *loadfunct(void *lib, const char *name) {
  void *ret = dlsym(lib, name);
  if (!ret) LOGE("dlsym: %s not found", name);
  return ret;
}
...
static void gladLoadEGL(void) {
  ...
  // EGL Core Functions
  eglChooseConfig = (EGLBoolean(*)(EGLDisplay, const EGLint *, EGLConfig *, EGLint, EGLint *))loadfunct(src->egllib, "eglChooseConfig");
  eglCopyBuffers = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLNativePixmapType))loadfunct(src->egllib, "eglCopyBuffers");
  eglCreateContext = (EGLContext(*)(EGLDisplay, EGLConfig, EGLContext, const EGLint *))loadfunct(src->egllib, "eglCreateContext");
  eglCreatePbufferSurface = (EGLSurface(*)(EGLDisplay, EGLConfig, const EGLint *))loadfunct(src->egllib, "eglCreatePbufferSurface");
  eglCreatePixmapSurface = (EGLSurface(*)(EGLDisplay, EGLConfig, EGLNativePixmapType, const EGLint *))loadfunct(src->egllib, "eglCreatePixmapSurface");
  eglCreateWindowSurface = (EGLSurface(*)(EGLDisplay, EGLConfig, EGLNativeWindowType, const EGLint *))loadfunct(src->egllib, "eglCreateWindowSurface");
  eglDestroyContext = (EGLBoolean(*)(EGLDisplay, EGLContext))loadfunct(src->egllib, "eglDestroyContext");
  eglDestroySurface = (EGLBoolean(*)(EGLDisplay, EGLSurface))loadfunct(src->egllib, "eglDestroySurface");
  eglGetConfigAttrib = (EGLBoolean(*)(EGLDisplay, EGLConfig, EGLint, EGLint *))loadfunct(src->egllib, "eglGetConfigAttrib");
  eglGetConfigs = (EGLBoolean(*)(EGLDisplay, EGLConfig *, EGLint, EGLint *))loadfunct(src->egllib, "eglGetConfigs");
  eglGetCurrentDisplay = (EGLDisplay(*)(void))loadfunct(src->egllib, "eglGetCurrentDisplay");
  eglGetCurrentSurface = (EGLSurface(*)(EGLint))loadfunct(src->egllib, "eglGetCurrentSurface");
  eglGetDisplay = (EGLDisplay(*)(EGLNativeDisplayType))loadfunct(src->egllib, "eglGetDisplay");
  eglGetError = (EGLint(*)(void))loadfunct(src->egllib, "eglGetError");
  eglInitialize = (EGLBoolean(*)(EGLDisplay, EGLint *, EGLint *))loadfunct(src->egllib, "eglInitialize");
  eglMakeCurrent = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLSurface, EGLContext))loadfunct(src->egllib, "eglMakeCurrent");
  eglQueryContext = (EGLBoolean(*)(EGLDisplay, EGLContext, EGLint, EGLint *))loadfunct(src->egllib, "eglQueryContext");
  eglQueryString = (const char *(*)(EGLDisplay, EGLint))loadfunct(src->egllib, "eglQueryString");
  eglQuerySurface = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLint, EGLint *))loadfunct(src->egllib, "eglQuerySurface");
  eglSwapBuffers = (EGLBoolean(*)(EGLDisplay, EGLSurface))loadfunct(src->egllib, "eglSwapBuffers");
  eglTerminate = (EGLBoolean(*)(EGLDisplay))loadfunct(src->egllib, "eglTerminate");
  eglWaitGL = (EGLBoolean(*)(void))loadfunct(src->egllib, "eglWaitGL");
  eglWaitNative = (EGLBoolean(*)(EGLint))loadfunct(src->egllib, "eglWaitNative");

  // EGL 1.1 Functions
  eglBindTexImage = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLint))loadfunct(src->egllib, "eglBindTexImage");
  eglReleaseTexImage = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLint))loadfunct(src->egllib, "eglReleaseTexImage");
  eglSurfaceAttrib = (EGLBoolean(*)(EGLDisplay, EGLSurface, EGLint, EGLint))loadfunct(src->egllib, "eglSurfaceAttrib");
  eglSwapInterval = (EGLBoolean(*)(EGLDisplay, EGLint))loadfunct(src->egllib, "eglSwapInterval");

  // EGL 1.2 Functions
  eglBindAPI = (EGLBoolean(*)(EGLenum))loadfunct(src->egllib, "eglBindAPI");
  eglQueryAPI = (EGLenum(*)(void))loadfunct(src->egllib, "eglQueryAPI");
  eglCreatePbufferFromClientBuffer = (EGLSurface(*)(EGLDisplay, EGLenum, EGLClientBuffer, EGLConfig, const EGLint *))loadfunct(src->egllib, "eglCreatePbufferFromClientBuffer");
  eglReleaseThread = (EGLBoolean(*)(void))loadfunct(src->egllib, "eglReleaseThread");
  eglWaitClient = (EGLBoolean(*)(void))loadfunct(src->egllib, "eglWaitClient");

  // EGL 1.4 Functions
  eglGetCurrentContext = (EGLContext(*)(void))loadfunct(src->egllib, "eglGetCurrentContext");
}
// END IMPLEMENTS EGL
...
static void gladLoadGLES(void) {
  ...
  // --- GL ES 2.0 Core Functions ---
  glActiveTexture = (void (*)(GLenum))loadfunct(src->gleslib, "glActiveTexture");
  glAttachShader = (void (*)(GLuint, GLuint))loadfunct(src->gleslib, "glAttachShader");
  glBindAttribLocation = (void (*)(GLuint, GLuint, const GLchar *))loadfunct(src->gleslib, "glBindAttribLocation");
  glBindBuffer = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBindBuffer");
  glBindFramebuffer = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBindFramebuffer");
  glBindRenderbuffer = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBindRenderbuffer");
  glBindTexture = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBindTexture");
  glBlendColor = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glBlendColor");
  glBlendEquation = (void (*)(GLenum))loadfunct(src->gleslib, "glBlendEquation");
  glBlendEquationSeparate = (void (*)(GLenum, GLenum))loadfunct(src->gleslib, "glBlendEquationSeparate");
  glBlendFunc = (void (*)(GLenum, GLenum))loadfunct(src->gleslib, "glBlendFunc");
  glBlendFuncSeparate = (void (*)(GLenum, GLenum, GLenum, GLenum))loadfunct(src->gleslib, "glBlendFuncSeparate");
  glClear = (void (*)(GLbitfield))loadfunct(src->gleslib, "glClear");
  glClearColor = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glClearColor");
  glClearDepthf = (void (*)(GLfloat))loadfunct(src->gleslib, "glClearDepthf");
  glClearStencil = (void (*)(GLint))loadfunct(src->gleslib, "glClearStencil");
  glColorMask = (void (*)(GLboolean, GLboolean, GLboolean, GLboolean))loadfunct(src->gleslib, "glColorMask");
  glCompileShader = (void (*)(GLuint))loadfunct(src->gleslib, "glCompileShader");
  glCompressedTexImage2D = (void (*)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const void *))loadfunct(src->gleslib, "glCompressedTexImage2D");
  glCompressedTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void *))loadfunct(src->gleslib, "glCompressedTexSubImage2D");
  glCopyTexImage2D = (void (*)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint))loadfunct(src->gleslib, "glCopyTexImage2D");
  glCopyTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))loadfunct(src->gleslib, "glCopyTexSubImage2D");
  glCreateProgram = (GLuint(*)(void))loadfunct(src->gleslib, "glCreateProgram");
  glCreateShader = (GLuint(*)(GLenum))loadfunct(src->gleslib, "glCreateShader");
  glCullFace = (void (*)(GLenum))loadfunct(src->gleslib, "glCullFace");
  glDeleteBuffers = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteBuffers");
  glDeleteFramebuffers = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteFramebuffers");
  glDeleteProgram = (void (*)(GLuint))loadfunct(src->gleslib, "glDeleteProgram");
  glDeleteRenderbuffers = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteRenderbuffers");
  glDeleteShader = (void (*)(GLuint))loadfunct(src->gleslib, "glDeleteShader");
  glDeleteTextures = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteTextures");
  glDepthFunc = (void (*)(GLenum))loadfunct(src->gleslib, "glDepthFunc");
  glDepthMask = (void (*)(GLboolean))loadfunct(src->gleslib, "glDepthMask");
  glDepthRangef = (void (*)(GLfloat, GLfloat))loadfunct(src->gleslib, "glDepthRangef");
  glDetachShader = (void (*)(GLuint, GLuint))loadfunct(src->gleslib, "glDetachShader");
  glDisable = (void (*)(GLenum))loadfunct(src->gleslib, "glDisable");
  glDisableVertexAttribArray = (void (*)(GLuint))loadfunct(src->gleslib, "glDisableVertexAttribArray");
  glDrawArrays = (void (*)(GLenum, GLint, GLsizei))loadfunct(src->gleslib, "glDrawArrays");
  glDrawElements = (void (*)(GLenum, GLsizei, GLenum, const void *))loadfunct(src->gleslib, "glDrawElements");
  glEnable = (void (*)(GLenum))loadfunct(src->gleslib, "glEnable");
  glEnableVertexAttribArray = (void (*)(GLuint))loadfunct(src->gleslib, "glEnableVertexAttribArray");
  glFinish = (void (*)(void))loadfunct(src->gleslib, "glFinish");
  glFlush = (void (*)(void))loadfunct(src->gleslib, "glFlush");
  glFramebufferRenderbuffer = (void (*)(GLenum, GLenum, GLenum, GLuint))loadfunct(src->gleslib, "glFramebufferRenderbuffer");
  glFramebufferTexture2D = (void (*)(GLenum, GLenum, GLenum, GLuint, GLint))loadfunct(src->gleslib, "glFramebufferTexture2D");
  glFrontFace = (void (*)(GLenum))loadfunct(src->gleslib, "glFrontFace");
  glGenBuffers = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenBuffers");
  glGenerateMipmap = (void (*)(GLenum))loadfunct(src->gleslib, "glGenerateMipmap");
  glGenFramebuffers = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenFramebuffers");
  glGenRenderbuffers = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenRenderbuffers");
  glGenTextures = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenTextures");
  glGetActiveAttrib = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *))loadfunct(src->gleslib, "glGetActiveAttrib");
  glGetActiveUniform = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *))loadfunct(src->gleslib, "glGetActiveUniform");
  glGetAttachedShaders = (void (*)(GLuint, GLsizei, GLsizei *, GLuint *))loadfunct(src->gleslib, "glGetAttachedShaders");
  glGetAttribLocation = (GLint(*)(GLuint, const GLchar *))loadfunct(src->gleslib, "glGetAttribLocation");
  glGetBooleanv = (void (*)(GLenum, GLboolean *))loadfunct(src->gleslib, "glGetBooleanv");
  glGetBufferParameteriv = (void (*)(GLenum, GLenum, GLint *))loadfunct(src->gleslib, "glGetBufferParameteriv");
  glGetError = (GLenum(*)(void))loadfunct(src->gleslib, "glGetError");
  glGetFloatv = (void (*)(GLenum, GLfloat *))loadfunct(src->gleslib, "glGetFloatv");
  glGetFramebufferAttachmentParameteriv = (void (*)(GLenum, GLenum, GLenum, GLint *))loadfunct(src->gleslib, "glGetFramebufferAttachmentParameteriv");
  glGetIntegerv = (void (*)(GLenum, GLint *))loadfunct(src->gleslib, "glGetIntegerv");
  glGetProgramiv = (void (*)(GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetProgramiv");
  glGetProgramInfoLog = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetProgramInfoLog");
  glGetRenderbufferParameteriv = (void (*)(GLenum, GLenum, GLint *))loadfunct(src->gleslib, "glGetRenderbufferParameteriv");
  glGetShaderiv = (void (*)(GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetShaderiv");
  glGetShaderInfoLog = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetShaderInfoLog");
  glGetShaderPrecisionFormat = (void (*)(GLenum, GLenum, GLint *, GLint *))loadfunct(src->gleslib, "glGetShaderPrecisionFormat");
  glGetShaderSource = (void (*)(GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetShaderSource");
  glGetString = (const GLubyte *(*)(GLenum))loadfunct(src->gleslib, "glGetString");
  glGetTexParameterfv = (void (*)(GLenum, GLenum, GLfloat *))loadfunct(src->gleslib, "glGetTexParameterfv");
  glGetTexParameteriv = (void (*)(GLenum, GLenum, GLint *))loadfunct(src->gleslib, "glGetTexParameteriv");
  glGetUniformLocation = (GLint(*)(GLuint, const GLchar *))loadfunct(src->gleslib, "glGetUniformLocation");
  glGetUniformfv = (void (*)(GLuint, GLint, GLfloat *))loadfunct(src->gleslib, "glGetUniformfv");
  glGetUniformiv = (void (*)(GLuint, GLint, GLint *))loadfunct(src->gleslib, "glGetUniformiv");
  glGetVertexAttribfv = (void (*)(GLuint, GLenum, GLfloat *))loadfunct(src->gleslib, "glGetVertexAttribfv");
  glGetVertexAttribiv = (void (*)(GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetVertexAttribiv");
  glGetVertexAttribPointerv = (void (*)(GLuint, GLenum, void **))loadfunct(src->gleslib, "glGetVertexAttribPointerv");
  glHint = (void (*)(GLenum, GLenum))loadfunct(src->gleslib, "glHint");
  glIsBuffer = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsBuffer");
  glIsEnabled = (GLboolean(*)(GLenum))loadfunct(src->gleslib, "glIsEnabled");
  glIsFramebuffer = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsFramebuffer");
  glIsProgram = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsProgram");
  glIsRenderbuffer = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsRenderbuffer");
  glIsShader = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsShader");
  glIsTexture = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsTexture");
  glLineWidth = (void (*)(GLfloat))loadfunct(src->gleslib, "glLineWidth");
  glLinkProgram = (void (*)(GLuint))loadfunct(src->gleslib, "glLinkProgram");
  glPixelStorei = (void (*)(GLenum, GLint))loadfunct(src->gleslib, "glPixelStorei");
  glPolygonOffset = (void (*)(GLfloat, GLfloat))loadfunct(src->gleslib, "glPolygonOffset");
  glReadPixels = (void (*)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *))loadfunct(src->gleslib, "glReadPixels");
  glReleaseShaderCompiler = (void (*)(void))loadfunct(src->gleslib, "glReleaseShaderCompiler");
  glRenderbufferStorage = (void (*)(GLenum, GLenum, GLsizei, GLsizei))loadfunct(src->gleslib, "glRenderbufferStorage");
  glSampleCoverage = (void (*)(GLfloat, GLboolean))loadfunct(src->gleslib, "glSampleCoverage");
  glScissor = (void (*)(GLint, GLint, GLsizei, GLsizei))loadfunct(src->gleslib, "glScissor");
  glShaderBinary = (void (*)(GLsizei, const GLuint *, GLenum, const void *, GLsizei))loadfunct(src->gleslib, "glShaderBinary");
  glShaderSource = (void (*)(GLuint, GLsizei, const GLchar *const *, const GLint *))loadfunct(src->gleslib, "glShaderSource");
  glStencilFunc = (void (*)(GLenum, GLint, GLuint))loadfunct(src->gleslib, "glStencilFunc");
  glStencilFuncSeparate = (void (*)(GLenum, GLenum, GLint, GLuint))loadfunct(src->gleslib, "glStencilFuncSeparate");
  glStencilMask = (void (*)(GLuint))loadfunct(src->gleslib, "glStencilMask");
  glStencilMaskSeparate = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glStencilMaskSeparate");
  glStencilOp = (void (*)(GLenum, GLenum, GLenum))loadfunct(src->gleslib, "glStencilOp");
  glStencilOpSeparate = (void (*)(GLenum, GLenum, GLenum, GLenum))loadfunct(src->gleslib, "glStencilOpSeparate");
  glTexImage2D = (void (*)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *))loadfunct(src->gleslib, "glTexImage2D");
  glTexParameterf = (void (*)(GLenum, GLenum, GLfloat))loadfunct(src->gleslib, "glTexParameterf");
  glTexParameterfv = (void (*)(GLenum, GLenum, const GLfloat *))loadfunct(src->gleslib, "glTexParameterfv");
  glTexParameteri = (void (*)(GLenum, GLenum, GLint))loadfunct(src->gleslib, "glTexParameteri");
  glTexParameteriv = (void (*)(GLenum, GLenum, const GLint *))loadfunct(src->gleslib, "glTexParameteriv");
  glTexSubImage2D = (void (*)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void *))loadfunct(src->gleslib, "glTexSubImage2D");
  glUniform1f = (void (*)(GLint, GLfloat))loadfunct(src->gleslib, "glUniform1f");
  glUniform1fv = (void (*)(GLint, GLsizei, const GLfloat *))loadfunct(src->gleslib, "glUniform1fv");
  glUniform1i = (void (*)(GLint, GLint))loadfunct(src->gleslib, "glUniform1i");
  glUniform1iv = (void (*)(GLint, GLsizei, const GLint *))loadfunct(src->gleslib, "glUniform1iv");
  glUniform2f = (void (*)(GLint, GLfloat, GLfloat))loadfunct(src->gleslib, "glUniform2f");
  glUniform2fv = (void (*)(GLint, GLsizei, const GLfloat *))loadfunct(src->gleslib, "glUniform2fv");
  glUniform2i = (void (*)(GLint, GLint, GLint))loadfunct(src->gleslib, "glUniform2i");
  glUniform2iv = (void (*)(GLint, GLsizei, const GLint *))loadfunct(src->gleslib, "glUniform2iv");
  glUniform3f = (void (*)(GLint, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glUniform3f");
  glUniform3fv = (void (*)(GLint, GLsizei, const GLfloat *))loadfunct(src->gleslib, "glUniform3fv");
  glUniform3i = (void (*)(GLint, GLint, GLint, GLint))loadfunct(src->gleslib, "glUniform3i");
  glUniform3iv = (void (*)(GLint, GLsizei, const GLint *))loadfunct(src->gleslib, "glUniform3iv");
  glUniform4f = (void (*)(GLint, GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glUniform4f");
  glUniform4fv = (void (*)(GLint, GLsizei, const GLfloat *))loadfunct(src->gleslib, "glUniform4fv");
  glUniform4i = (void (*)(GLint, GLint, GLint, GLint, GLint))loadfunct(src->gleslib, "glUniform4i");
  glUniform4iv = (void (*)(GLint, GLsizei, const GLint *))loadfunct(src->gleslib, "glUniform4iv");
  glUniformMatrix2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix2fv");
  glUniformMatrix3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix3fv");
  glUniformMatrix4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix4fv");
  glUseProgram = (void (*)(GLuint))loadfunct(src->gleslib, "glUseProgram");
  glValidateProgram = (void (*)(GLuint))loadfunct(src->gleslib, "glValidateProgram");
  glVertexAttrib1f = (void (*)(GLuint, GLfloat))loadfunct(src->gleslib, "glVertexAttrib1f");
  glVertexAttrib1fv = (void (*)(GLuint, const GLfloat *))loadfunct(src->gleslib, "glVertexAttrib1fv");
  glVertexAttrib2f = (void (*)(GLuint, GLfloat, GLfloat))loadfunct(src->gleslib, "glVertexAttrib2f");
  glVertexAttrib2fv = (void (*)(GLuint, const GLfloat *))loadfunct(src->gleslib, "glVertexAttrib2fv");
  glVertexAttrib3f = (void (*)(GLuint, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glVertexAttrib3f");
  glVertexAttrib3fv = (void (*)(GLuint, const GLfloat *))loadfunct(src->gleslib, "glVertexAttrib3fv");
  glVertexAttrib4f = (void (*)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glVertexAttrib4f");
  glVertexAttrib4fv = (void (*)(GLuint, const GLfloat *))loadfunct(src->gleslib, "glVertexAttrib4fv");
  glVertexAttribPointer = (void (*)(GLuint, GLint, GLenum, GLboolean, GLsizei, const void *))loadfunct(src->gleslib, "glVertexAttribPointer");
  glViewport = (void (*)(GLint, GLint, GLsizei, GLsizei))loadfunct(src->gleslib, "glViewport");
  glBufferData = (void (*)(GLenum, GLsizeiptr, const void *, GLenum))loadfunct(src->gleslib, "glBufferData");
  glBufferSubData = (void (*)(GLenum, GLintptr, GLsizeiptr, const void *))loadfunct(src->gleslib, "glBufferSubData");

  // --- GL ES 3.0 Core Functions ---
  glReadBuffer = (void (*)(GLenum))loadfunct(src->gleslib, "glReadBuffer");
  glDrawRangeElements = (void (*)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *))loadfunct(src->gleslib, "glDrawRangeElements");
  glTexImage3D = (void (*)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *))loadfunct(src->gleslib, "glTexImage3D");
  glTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *))loadfunct(src->gleslib, "glTexSubImage3D");
  glCopyTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))loadfunct(src->gleslib, "glCopyTexSubImage3D");
  glCompressedTexImage3D = (void (*)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const void *))loadfunct(src->gleslib, "glCompressedTexImage3D");
  glCompressedTexSubImage3D = (void (*)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *))loadfunct(src->gleslib, "glCompressedTexSubImage3D");
  glGenQueries = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenQueries");
  glDeleteQueries = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteQueries");
  glIsQuery = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsQuery");
  glBeginQuery = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBeginQuery");
  glEndQuery = (void (*)(GLenum))loadfunct(src->gleslib, "glEndQuery");
  glGetQueryiv = (void (*)(GLenum, GLenum, GLint *))loadfunct(src->gleslib, "glGetQueryiv");
  glGetQueryObjectuiv = (void (*)(GLuint, GLenum, GLuint *))loadfunct(src->gleslib, "glGetQueryObjectuiv");
  glUnmapBuffer = (void (*)(GLenum))loadfunct(src->gleslib, "glUnmapBuffer");
  glMapBufferRange = (const void *(*)(GLenum, GLintptr, GLsizeiptr, GLbitfield))loadfunct(src->gleslib, "glMapBufferRange");
  glFlushMappedBufferRange = (void (*)(GLenum, GLintptr, GLsizeiptr))loadfunct(src->gleslib, "glFlushMappedBufferRange");
  glGenSamplers = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenSamplers");
  glDeleteSamplers = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteSamplers");
  glIsSampler = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsSampler");
  glBindSampler = (void (*)(GLuint, GLuint))loadfunct(src->gleslib, "glBindSampler");
  glSamplerParameterf = (void (*)(GLuint, GLenum, GLfloat))loadfunct(src->gleslib, "glSamplerParameterf");
  glSamplerParameterfv = (void (*)(GLuint, GLenum, const GLfloat *))loadfunct(src->gleslib, "glSamplerParameterfv");
  glSamplerParameteri = (void (*)(GLuint, GLenum, GLint))loadfunct(src->gleslib, "glSamplerParameteri");
  glSamplerParameteriv = (void (*)(GLuint, GLenum, const GLint *))loadfunct(src->gleslib, "glSamplerParameteriv");
  glGetSamplerParameterfv = (void (*)(GLuint, GLenum, GLfloat *))loadfunct(src->gleslib, "glGetSamplerParameterfv");
  glGetSamplerParameteriv = (void (*)(GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetSamplerParameteriv");
  glVertexAttribDivisor = (void (*)(GLuint, GLuint))loadfunct(src->gleslib, "glVertexAttribDivisor");
  glBindTransformFeedback = (void (*)(GLenum, GLuint))loadfunct(src->gleslib, "glBindTransformFeedback");
  glDeleteTransformFeedbacks = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteTransformFeedbacks");
  glIsTransformFeedback = (GLboolean(*)(GLuint))loadfunct(src->gleslib, "glIsTransformFeedback");
  glGenTransformFeedbacks = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenTransformFeedbacks");
  glPauseTransformFeedback = (void (*)(void))loadfunct(src->gleslib, "glPauseTransformFeedback");
  glResumeTransformFeedback = (void (*)(void))loadfunct(src->gleslib, "glResumeTransformFeedback");
  glBeginTransformFeedback = (void (*)(GLenum))loadfunct(src->gleslib, "glBeginTransformFeedback");
  glEndTransformFeedback = (void (*)(void))loadfunct(src->gleslib, "glEndTransformFeedback");
  glTransformFeedbackVaryings = (void (*)(GLuint, GLsizei, const GLchar *const *, GLenum))loadfunct(src->gleslib, "glTransformFeedbackVaryings");
  glGetTransformFeedbackVarying = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, GLchar *))loadfunct(src->gleslib, "glGetTransformFeedbackVarying");
  glBindBufferRange = (void (*)(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr))loadfunct(src->gleslib, "glBindBufferRange");
  glBindBufferBase = (void (*)(GLenum, GLuint, GLuint))loadfunct(src->gleslib, "glBindBufferBase");
  glGetActiveUniformBlockName = (void (*)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetActiveUniformBlockName");
  glGetActiveUniformBlockiv = (void (*)(GLuint, GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetActiveUniformBlockiv");
  glGetUniformBlockIndex = (void (*)(GLuint, const GLchar *))loadfunct(src->gleslib, "glGetUniformBlockIndex");
  glUniformBlockBinding = (void (*)(GLuint, GLuint, GLuint))loadfunct(src->gleslib, "glUniformBlockBinding");
  glGetUniformIndices = (void (*)(GLuint, GLsizei, const GLchar *const *, GLuint *))loadfunct(src->gleslib, "glGetUniformIndices");
  glGetActiveUniformsiv = (void (*)(GLuint, GLsizei, const GLuint *, GLenum, GLint *))loadfunct(src->gleslib, "glGetActiveUniformsiv");
  glFenceSync = (GLsync(*)(GLenum, GLbitfield))loadfunct(src->gleslib, "glFenceSync");
  glIsSync = (GLboolean(*)(GLsync))loadfunct(src->gleslib, "glIsSync");
  glDeleteSync = (void (*)(GLsync))loadfunct(src->gleslib, "glDeleteSync");
  glClientWaitSync = (GLenum(*)(GLsync, GLbitfield, GLuint64))loadfunct(src->gleslib, "glClientWaitSync");
  glWaitSync = (void (*)(GLsync, GLbitfield, GLuint64))loadfunct(src->gleslib, "glWaitSync");
  glGetInteger64v = (void (*)(GLenum, GLint64 *))loadfunct(src->gleslib, "glGetInteger64v");
  glGetSynciv = (void (*)(GLsync, GLenum, GLsizei, GLsizei *, GLint *))loadfunct(src->gleslib, "glGetSynciv");
  glCopyBufferSubData = (void (*)(GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr))loadfunct(src->gleslib, "glCopyBufferSubData");
  glGetBufferParameteri64v = (void (*)(GLenum, GLenum, GLint64 *))loadfunct(src->gleslib, "glGetBufferParameteri64v");
  glBlitFramebuffer = (void (*)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum))loadfunct(src->gleslib, "glBlitFramebuffer");
  glCheckFramebufferStatus = (GLenum(*)(GLenum))loadfunct(src->gleslib, "glCheckFramebufferStatus");
  glDrawArraysInstanced = (void (*)(GLenum, GLint, GLsizei, GLsizei))loadfunct(src->gleslib, "glDrawArraysInstanced");
  glDrawElementsInstanced = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei))loadfunct(src->gleslib, "glDrawElementsInstanced");
  glFramebufferTextureLayer = (void (*)(GLenum, GLenum, GLuint, GLint, GLint))loadfunct(src->gleslib, "glFramebufferTextureLayer");
  glGetIntegeri_v = (void (*)(GLenum, GLuint, GLint *))loadfunct(src->gleslib, "glGetIntegeri_v");
  glGetProgramBinary = (void (*)(GLuint, GLsizei, GLsizei *, GLenum *, void *))loadfunct(src->gleslib, "glGetProgramBinary");
  glGetStringi = (const GLubyte *(*)(GLenum, GLuint))loadfunct(src->gleslib, "glGetStringi");
  glProgramBinary = (void (*)(GLuint, GLenum, const void *, GLsizei))loadfunct(src->gleslib, "glProgramBinary");
  glProgramParameteri = (void (*)(GLuint, GLenum, GLint))loadfunct(src->gleslib, "glProgramParameteri");
  glTexStorage2D = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei))loadfunct(src->gleslib, "glTexStorage2D");
  glTexStorage3D = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei))loadfunct(src->gleslib, "glTexStorage3D");
  glUniformMatrix2x3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix2x3fv");
  glUniformMatrix3x2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix3x2fv");
  glUniformMatrix2x4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix2x4fv");
  glUniformMatrix4x2fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix4x2fv");
  glUniformMatrix3x4fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix3x4fv");
  glUniformMatrix4x3fv = (void (*)(GLint, GLsizei, GLboolean, const GLfloat *))loadfunct(src->gleslib, "glUniformMatrix4x3fv");
  glVertexAttribI4i = (void (*)(GLuint, GLint, GLint, GLint, GLint))loadfunct(src->gleslib, "glVertexAttribI4i");
  glVertexAttribI4iv = (void (*)(GLuint, const GLint *))loadfunct(src->gleslib, "glVertexAttribI4iv");
  glVertexAttribI4ui = (void (*)(GLuint, GLuint, GLuint, GLuint, GLuint))loadfunct(src->gleslib, "glVertexAttribI4ui");
  glVertexAttribI4uiv = (void (*)(GLuint, const GLuint *))loadfunct(src->gleslib, "glVertexAttribI4uiv");
  glVertexAttribIPointer = (void (*)(GLuint, GLint, GLenum, GLsizei, const void *))loadfunct(src->gleslib, "glVertexAttribIPointer");
  glGetVertexAttribIiv = (void (*)(GLuint, GLenum, GLint *))loadfunct(src->gleslib, "glGetVertexAttribIiv");
  glGetVertexAttribIuiv = (void (*)(GLuint, GLenum, GLuint *))loadfunct(src->gleslib, "glGetVertexAttribIuiv");
  glGetFragDataLocation = (GLint(*)(GLuint, const GLchar *))loadfunct(src->gleslib, "glGetFragDataLocation");
  glGenVertexArrays = (void (*)(GLsizei, GLuint *))loadfunct(src->gleslib, "glGenVertexArrays");
  glBindVertexArray = (void (*)(GLuint))loadfunct(src->gleslib, "glBindVertexArray");
  glDeleteVertexArrays = (void (*)(GLsizei, const GLuint *))loadfunct(src->gleslib, "glDeleteVertexArrays");

  // --- GL ES 3.1 Core Functions ---
  glDispatchCompute = (void (*)(GLuint, GLuint, GLuint))loadfunct(src->gleslib, "glDispatchCompute");
  glDispatchComputeIndirect = (void (*)(GLintptr))loadfunct(src->gleslib, "glDispatchComputeIndirect");
  glDrawArraysIndirect = (void (*)(GLenum, const void *))loadfunct(src->gleslib, "glDrawArraysIndirect");
  glDrawElementsIndirect = (void (*)(GLenum, GLenum, const void *))loadfunct(src->gleslib, "glDrawElementsIndirect");
  glFramebufferTexture = (void (*)(GLenum, GLenum, GLuint, GLint))loadfunct(src->gleslib, "glFramebufferTexture");
  glGetProgramResourceIndex = (void (*)(GLuint, GLenum, const GLchar *))loadfunct(src->gleslib, "glGetProgramResourceIndex");
  glGetProgramResourceName = (void (*)(GLuint, GLenum, GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetProgramResourceName");
  glGetProgramResourceiv = (void (*)(GLuint, GLenum, GLuint, GLsizei, const GLenum *, GLsizei, GLsizei *, GLint *))loadfunct(src->gleslib, "glGetProgramResourceiv");
  glGetProgramResourceLocation = (GLint(*)(GLuint, GLenum, const GLchar *))loadfunct(src->gleslib, "glGetProgramResourceLocation");
  glShaderStorageBlockBinding = (void (*)(GLuint, GLuint, GLuint))loadfunct(src->gleslib, "glShaderStorageBlockBinding");
  glTexBuffer = (void (*)(GLenum, GLenum, GLuint))loadfunct(src->gleslib, "glTexBuffer");
  glTexBufferRange = (void (*)(GLenum, GLenum, GLuint, GLintptr, GLsizeiptr))loadfunct(src->gleslib, "glTexBufferRange");
  glTexImage2DMultisample = (void (*)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean))loadfunct(src->gleslib, "glTexImage2DMultisample");

  // --- GL ES 3.2 Core Functions ---
  glBlendBarrier = (void (*)(void))loadfunct(src->gleslib, "glBlendBarrier"); // Also an extension
  glDebugMessageControl = (void (*)(GLenum, GLenum, GLenum, GLsizei, const GLuint *, GLboolean))loadfunct(src->gleslib, "glDebugMessageControl");
  glDebugMessageInsert = (void (*)(GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *))loadfunct(src->gleslib, "glDebugMessageInsert");
  glDebugMessageCallback = (void (*)(GLDEBUGPROC, const void *))loadfunct(src->gleslib, "glDebugMessageCallback");
  glGetDebugMessageLog = (GLuint(*)(GLuint, GLsizei, GLenum *, GLenum *, GLuint *, GLenum *, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetDebugMessageLog");
  glPushDebugGroup = (void (*)(GLenum, GLuint, GLsizei, const GLchar *))loadfunct(src->gleslib, "glPushDebugGroup");
  glPopDebugGroup = (void (*)(void))loadfunct(src->gleslib, "glPopDebugGroup");
  glObjectLabel = (void (*)(GLenum, GLuint, GLsizei, const GLchar *))loadfunct(src->gleslib, "glObjectLabel");
  glGetObjectLabel = (void (*)(GLenum, GLuint, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetObjectLabel");
  glObjectPtrLabel = (void (*)(const void *, GLsizei, const GLchar *))loadfunct(src->gleslib, "glObjectPtrLabel");
  glGetObjectPtrLabel = (void (*)(const void *, GLsizei, GLsizei *, GLchar *))loadfunct(src->gleslib, "glGetObjectPtrLabel");
  glGetPointerv = (void (*)(GLenum, void **))loadfunct(src->gleslib, "glGetPointerv");
  glPrimitiveBoundingBoxEXT = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glPrimitiveBoundingBoxEXT"); // Also core in 3.2
  glPatchParameteriEXT = (void (*)(GLenum, GLint))loadfunct(src->gleslib, "glPatchParameteriEXT");                                                                    // Also core in 3.2
  glDrawElementsBaseVertex = (void (*)(GLenum, GLsizei, GLenum, const void *, GLint))loadfunct(src->gleslib, "glDrawElementsBaseVertex");
  glDrawRangeElementsBaseVertex = (void (*)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *, GLint))loadfunct(src->gleslib, "glDrawRangeElementsBaseVertex");
  glDrawElementsInstancedBaseVertex = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei, GLint))loadfunct(src->gleslib, "glDrawElementsInstancedBaseVertex");
  glDrawElementsInstancedBaseInstanceEXT = (void (*)(GLenum, GLsizei, GLenum, const void *, GLsizei, GLuint))loadfunct(src->gleslib, "glDrawElementsInstancedBaseInstanceEXT");
  glPrimitiveBoundingBox = (void (*)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat))loadfunct(src->gleslib, "glPrimitiveBoundingBox");
  glPatchParameteri = (void (*)(GLenum, GLint))loadfunct(src->gleslib, "glPatchParameteri");
}
